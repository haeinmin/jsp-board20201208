			...
			<div class="col-6">
				...
				<div class="list-container">
					<table class="table table-striped">
						<thead>
							<tr>
								<th class="num-col text-left"><i class="fab fa-slack-hash"></i></th>
								<th class="title-col text-center">제목</th>
...
<%--
	<div class="container">
		<table border="1">
			<tr>
				<td colspan="4"><a href="write.do">[게시글보기]</a></td>
			</tr>
			<tr>
				<td>번호</td>
				<td>제목</td>
